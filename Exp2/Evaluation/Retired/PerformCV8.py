...
from TrainEMLR8 import TrainEM
from numpy import matlib
from TestOutput import TestOutput7 
from TestOutput import PrintResults7 
...
def PerformCV():
   ...
   numpy.zeros((0,1)), numpy.zeros((0,1)), numpy.zeros((0,1)), numpy.zeros((0,1))
   for i in range(count_splits):
      ...
      [ground_truth,b1_output,b2_output,model_output] = TestOutput7(test_scores,test_vad_ts,test_features_ts,baseline1,baseline2,model)
      ...
      PrintResults7(all_ground_truth,all_b1_output,all_b2_output,all_model_output) 
      print ''
      print '======================'
      print ''
