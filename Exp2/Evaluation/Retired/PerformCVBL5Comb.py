...
def PerformCV():
   ...
   all_test_ground_truth, all_test_fusion_output, all_test_audio_output, all_test_video_output, all_test_b4_output, all_test_combined_output= \
   numpy.zeros((0,3)), numpy.zeros((0,3)), numpy.zeros((0,3)), numpy.zeros((0,3)), numpy.zeros((0,3)), numpy.zeros((0,3))
   all_dev_ground_truth, all_dev_fusion_output, all_dev_audio_output, all_dev_video_output, all_dev_b4_output, all_dev_combined_output= \
   numpy.zeros((0,3)), numpy.zeros((0,3)), numpy.zeros((0,3)), numpy.zeros((0,3)), numpy.zeros((0,3)), numpy.zeros((0,3))
   ...
   for alpha in range(11):
      wt = .1*alpha
      dev_combined = (wt*all_dev_video_output) + ((1-wt)*all_dev_audio_output) 
      test_combined = (wt*all_test_video_output) + ((1-wt)*all_test_audio_output) 
      print ''
      print 'Dev set results: combined'
      PrintResults(all_dev_ground_truth,dev_combined)
      print 'Test set results: combined'
      PrintResults(all_test_ground_truth,test_combined)
      print ''
