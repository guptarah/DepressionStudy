...
def PerformCV():
   ...
   for i in range(count_splits):
      ...
      train_audio_features = train_added_features_audio
      ...
      dev_audio_features = dev_added_features_audio
      test_audio_features = test_added_features_audio
      train_video_features = train_added_features_video
      ...
      dev_video_features = dev_added_features_video
      test_video_features = test_added_features_video
