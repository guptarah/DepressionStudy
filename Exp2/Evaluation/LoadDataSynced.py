...
def LoadData(input_dir):
   ...
   for patient_dir in os.listdir(input_dir):
      ...
      min_frames = numpy.amin([valence_values.shape[0],arousal_values.shape[0],dominance_values.shape[0],feature_values.shape[0]])
      ...
      feature_matrix = feature_values[0:min_frames,:] 
