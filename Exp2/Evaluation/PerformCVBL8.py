...
def PerformCV():
   ...
   for i in range(count_splits):
      ...
      train_audio_features = train_window_matrix_audio 
      train_labels_l1 = train_labels_matrix
      train_audio_features_l1 = train_audio_features
      dev_audio_features = dev_window_matrix_audio 
      test_audio_features = test_window_matrix_audio
      train_video_features = train_window_matrix_video
      train_video_features_l1 = train_video_features
      dev_video_features = dev_window_matrix_video
      test_video_features = test_window_matrix_video
